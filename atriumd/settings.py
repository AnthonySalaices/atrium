...
def schema():
    ...
    return [
        ...
        {"group": "Keyboard", "rows": [
            ...
            _step("kbd_w", "Width", "backdrop.passthrough.desk_window_width_m", 0.2, 1.2, 0.02, " m"),
            _step("kbd_h", "Depth", "backdrop.passthrough.desk_window_height_m", 0.1, 0.6, 0.02, " m"),
            ...
            _step("kbd_below", "Height", "backdrop.passthrough.desk_window_below_eye_m",
                  0.1, 0.9, 0.02, " m below eyes"),
            _step("kbd_right", "Left / right", "backdrop.passthrough.desk_window_right_m",
                  -0.5, 0.5, 0.02, " m"),
